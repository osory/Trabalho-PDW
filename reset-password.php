  ...
  <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <div class="well well-sm">
          ...
          <fieldset>
            <legend class="text-center">Alteração de Password</legend>
            ...
            <div class="form-group <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
                <label class="col-md-3 control-label" for="name">Confirmar Password</label>
                <div class="col-md-9">
            ...
            <div class="form-group">
                <div class="col-md-12 text-right">
                    ...
                    <a class="btn btn-link" href="main.php">Cancelar</a>
                </div>
            </div>
        </form>
          </fieldset>
